...
%
    ...
    \end{textblock*}
    %
    \begin{textblock*}{110mm}(10mm, 45mm)
        \only<5>{
            \begin{bibunit}[apalike]
        ...
        \only<8>{
            \begin{textblock*}{65mm}(30mm, 55mm)
                \begin{yellowbox}{Aim of this talk}
                    To illustrate the formulation of optimal 
                    Lockdown-vaccination policies
                    based in piecewise constant poicies.
                \end{yellowbox}
            \end{textblock*}
        }   
    \end{textblock*}
